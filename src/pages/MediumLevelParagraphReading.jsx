...
const MediumLevelParagraphReading = () => {
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-8">
            <p className="text-lg text-gray-600">
              Complete each level to unlock the next and improve your communication skills step by step.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mb-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <p className="text-gray-700">
                  Read the paragraph clearly and confidently. Avoid using filler words and maintain a steady pace while speaking.
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6">
                <p className="text-gray-800 leading-relaxed text-center">
                  In today's dynamic business environment, the ability to communicate effectively is not just an advantage but a necessity. I have consistently demonstrated strong interpersonal and presentation skills across various professional settings. My approach to communication emphasizes clarity, active listening, and adapting my message to diverse audiences. I believe that successful communication requires understanding the perspectives of others and building meaningful relationships based on trust and mutual respect.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-center">
              <button className="px-12 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-md">
                Start
              </button>
              <button 
                onClick={() => navigate('/medium-level-result')}
                className="px-12 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-md"
              >
                Submit
              </button>
            </div>
...
export default MediumLevelParagraphReading;
