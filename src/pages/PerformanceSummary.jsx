      ...
      <div className="flex-1 ml-20">
        ...
        <div className="bg-white shadow-sm sticky top-0 z-50">
          <div className="container mx-auto px-6 py-4">
            <h1 className="text-2xl font-bold text-gray-800">Performance Summary</h1>
            <p className="text-sm text-gray-500 mt-1">Overview of your speech practice progress and improvement.</p>
          </div>
        </div>

        {/* Page Content */}
        <div className="container mx-auto px-6 py-8 max-w-4xl space-y-5">

          {/* Overall Performance */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-base font-bold text-gray-800 mb-4">Overall Performance</h3>
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <p className="text-sm font-semibold text-blue-600 mb-1">Sessions</p>
                <p className="text-lg font-bold text-gray-800">6</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <p className="text-sm font-semibold text-blue-600 mb-1">Confidence</p>
                <p className="text-lg font-bold text-gray-800">Moderate</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <p className="text-sm font-semibold text-blue-600 mb-1">Clarity</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-base font-bold text-gray-800 mb-4">Common Speech Issues</h3>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 bg-gray-400 rounded-full flex-shrink-0"></span>
                Filler Words: "uhm", "you know"
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 bg-gray-400 rounded-full flex-shrink-0"></span>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-base font-bold text-gray-800 mb-4">Activity Performance</h3>
            <div className="space-y-2 text-sm text-gray-600">
              <p>Paragraph Reading: Completed (Easy → Hard)</p>
              <p>Mock Interview: 2 Sessions Completed</p>
            </div>
          </div>

          {/* AI Improvement Feedback */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-base font-bold text-gray-800 mb-4">AI Improvement Feedback</h3>
            <div className="bg-blue-50 rounded-lg p-4">
              <p className="text-sm text-gray-600 leading-relaxed">
                You are showing consistent improvement in your communication skills. Continue practicing to reduce
                filler words and improve your pacing for more professional speech delivery.
              </p>
            </div>
          </div>
