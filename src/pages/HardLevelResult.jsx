      ...
      <div className="flex-1 ml-20">
        ...
        <div className="bg-white shadow-sm sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-800">Hard Level - Paragraph Reading</h1>
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mb-10">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-gray-800">None detected</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-gray-800">Perfect</span>
                </div>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-3 list-disc list-inside">
                <li className="text-gray-700">Experiment with varied intonation for more expressive delivery</li>
                <li className="text-gray-700">Add strategic pauses for emphasis and audience comprehension</li>
                <li className="text-gray-700">Consider vocal dynamics to maintain audience engagement</li>
                <li className="text-gray-700">Practice public speaking to further enhance presentation skills</li>
              </ul>
            </div>

            {/* Feedback Message */}
            <div className="bg-purple-50 border-l-4 border-purple-500 p-4 mb-10">
              <p className="text-gray-800">
                Outstanding performance! You have demonstrated exceptional communication skills at the hard level. Your delivery is flawless with no filler words, perfect pacing, and excellent confidence. Your pronunciation is crystal clear, and your intonation effectively conveys the meaning of the text. You have successfully completed all levels and shown remarkable improvement. Congratulations on mastering paragraph reading at the highest difficulty level!
              </p>
            </div>
            ...
            <div className="flex gap-4 justify-center">
              <Link to="/hard-level-paragraph-reading">
                <button className="px-8 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors shadow-md">
                  Retry Hard Level
                </button>
              </Link>
              <Link to="/ParagraphReading">
                <button className="px-8 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors shadow-md">
                  Back to Paragraph Reading
                </button>
              </Link>
            </div>
          </div>
...
export default HardLevelResult;
