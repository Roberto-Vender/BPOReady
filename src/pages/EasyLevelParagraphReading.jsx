...
const EasyLevelParagraphReading = () => {
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mb-8">
              <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6">
                <p className="text-gray-800 leading-relaxed text-center">
                  I am a hardworking and dedicated person who enjoys helping others. I always try my best to communicate clearly and respectfully. I am willing to learn new things and improve my skills. I believe that good communication is important in providing excellent customer service.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Link to="/EasyLevelResult">
                <button className="px-12 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-gray-700 transition-colors shadow-md">
                  Submit
                </button>
              </Link>
...
export default EasyLevelParagraphReading;
